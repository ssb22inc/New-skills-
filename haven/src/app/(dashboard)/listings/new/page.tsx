...
export default function NewListingPage() {
  ...
  const handlePhotoAnalysis = async () => {
    ...
    try {
      ...
      // Generate listing from analysis
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-8">
        ...
        <p className="mt-1 text-gray-600">Use AI to create a compelling listing in minutes</p>
      </div>
        ...
        <TabsContent value="photos" className="mt-6">
          <Card>
            ...
            <CardContent>
              ...
              {photos.length >= 3 && (
                <div className="mt-4">
                  <Button onClick={handlePhotoAnalysis} disabled={aiGenerating}>
                    {aiGenerating ? (
                      <>
        ...
        <TabsContent value="details" className="mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Review and edit your listing information</CardDescription>
            </CardHeader>
