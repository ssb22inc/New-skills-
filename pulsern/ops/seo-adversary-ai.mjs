...
export async function runAdversary({
  ...
  const evidenceFiles = ["report.json", "provenance.json", "intent.json", "sources.json", "accessibility.json", "app-boundary.json", "crawl.json", "crawl-live.json"];
