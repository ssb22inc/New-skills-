...
export async function runAdversary({
  ...
  const evidenceFiles = ["report.json", "provenance.json", "intent.json", "commercial-governance.json", "commercial.json", "exam-rules.json", "sources.json", "accessibility.json", "app-boundary.json", "crawl.json", "crawl-live.json", "live-release.json", "live-release-crawl.json", "indexnow.json"];
