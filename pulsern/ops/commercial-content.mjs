...
const pages = [
  ...
  },
  {
    ...
    body: `<p class="lead"><strong>${QS} practice questions. A free day, no credit card.</strong> That is what PulseRN includes on every plan at $99, with ${CASES} case studies, ${CARDS} study cards, a searchable lab and vital-sign reference and educational nursing Q&amp;A in the same app. Archer's public package page lists 3,100+ questions from $79 for one month.</p>
      <div class="card best"><span class="tag">Try it before you pay</span><h2 style="margin-top:0">Archer costs $20 less to enter. Here is the honest way to decide.</h2><p>At the paid entry level Archer is cheaper, and that is worth something. PulseRN's answer is not a discount but a day of full access with no payment details required, so you can find out whether roughly three times the question volume and a connected daily workflow are worth $20 to you before either of you has your card number.</p><p><a class="button" href="/?start=1">Start PulseRN free for one day</a><a class="button alt" href="/how-it-works/">See how PulseRN works</a></p></div>
      ...
      ${table("PulseRN and Archer Review public-feature comparison", [
        ...
        ["Basic one-month entry", "$99 for 30 days, after a free day that needs no card", "QBank + CAT publicly listed from $79 for one month, marked down from $99", "Archer is $20 lower at the paid entry level. PulseRN's free day requires no payment details; Archer also advertises a trial, whose terms are not stated on the cited page."],
